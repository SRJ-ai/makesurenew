...
export const DEMO_REPOS: Repo[] = [
  {
    ...
    scan_results: {
      checks: {
        ...
        has_dependabot: true, has_description: true, has_changelog: true,
        has_issue_templates: true, has_pr_template: true,
      },
      issues: [],
    },
  },
  {
    ...
    scan_results: {
      checks: {
        ...
        has_dependabot: false, has_description: true, has_changelog: false,
      ...
      issues: [
        ...
        { check: 'has_dependabot', severity: 'high', message: 'No Dependabot config — add .github/dependabot.yml to automate dependency updates' },
        { check: 'has_security_policy', severity: 'high', message: 'No SECURITY.md — document how to report vulnerabilities' },
        { check: 'has_changelog', severity: 'medium', message: 'No CHANGELOG.md — document your release history for users and contributors' },
        { check: 'has_issue_templates', severity: 'medium', message: 'No issue templates — add .github/ISSUE_TEMPLATE to guide bug reports and feature requests' },
  ...
  },
  {
    ...
    scan_results: {
      ...
      issues: [
        ...
        { check: 'has_dependabot', severity: 'high', message: 'No Dependabot config — add .github/dependabot.yml to automate dependency updates' },
        { check: 'has_security_policy', severity: 'high', message: 'No SECURITY.md — document how to report vulnerabilities' },
        { check: 'has_recent_commits', severity: 'high', message: 'No commits in 90 days — consider archiving or updating' },
