...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white flex flex-col items-center justify-center px-4">
      {IS_DEMO && (
        <div className="mb-6 bg-yellow-900/40 border border-yellow-600/40 text-yellow-300 text-sm px-4 py-2 rounded-lg">
          Live demo — no login required. Click below to explore with sample data.
        </div>
      )}
